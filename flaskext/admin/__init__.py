...
class Admin(Module):
    ...
    module that is returned will still need to be registered to your
    flask app. Additional parameters will be passed to the module
    constructor.

    The parameters are:

    `app`
        The app that this Admin module will be associated with.
    ...
    `exclude_pks`
        ...
        the rendered forms. Primary keys are usually generated by your
        database and you might not want to allow them to be changed.
